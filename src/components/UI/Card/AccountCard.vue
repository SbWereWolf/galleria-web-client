...
<template>
  <div class="main-container1">
    <div class="group">
      <div class="wrapper">
        <!-- Используем аватарку из пропсов -->
        <div
          class="img"
    ...
    <div class="section">
      <div class="wrapper-2">
        <span class="text-2">Логин:</span><span class="text-3">{{ login }}</span>
      </div>
      <div class="wrapper-3">
        <span class="id">ID:</span><span class="text-5">{{ id }}</span>
      </div>
      <div class="frame" v-if="role === 'artist'">
      ...
      <div class="frame" v-if="role === 'visitor'">
        ...
        <span class="abstractionism">{{ address }}</span>
...
.text {
  ...
  height: 28px;
  color: #281101;
  font-family: Roboto Condensed, var(--default-font-family);
  font-size: 24px;
  font-weight: 500;
  line-height: 28px;
  text-align: left;
